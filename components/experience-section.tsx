      ...
      <div className="container-width">
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className="md:ml-20 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden card-hover">
                  {/* Header */}
                  <div className={`bg-gradient-to-r ${exp.color} p-4 sm:p-6 text-white`}>
                    <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <div className="text-left sm:text-right">
                        <div className="flex items-center space-x-2 text-blue-100 justify-start sm:justify-end">
                          <Calendar className="w-4 h-4" />
                          <span className="text-xs sm:text-sm">{exp.duration}</span>
                        </div>
                        <div className="flex items-center space-x-2 text-blue-100 mt-1 justify-start sm:justify-end">
                  ...
                  <div className="p-4 sm:p-6">
                      ...
                      <ul className="space-y-2">
                        {exp.achievements.map((achievement, achIndex) => (
                          <li key={achIndex} className="flex items-start space-x-3">
                            ...
                            <span className="text-gray-700 leading-relaxed text-sm sm:text-base">{achievement}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
                    ...
                    <div>
                      <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 flex items-center">
                        <Zap className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-500 mr-2" />
                        Technologies Used
                      </h4>
        ...
        >
          <div className="text-center p-4 sm:p-6 bg-blue-50 rounded-xl border border-blue-100">
            ...
            <div className="text-xs sm:text-sm text-gray-500">Fortune 500 to Startups</div>
          </div>
          <div className="text-center p-4 sm:p-6 bg-green-50 rounded-xl border border-green-100">
            <div className="text-2xl sm:text-3xl font-bold text-green-600 mb-2">8+</div>
